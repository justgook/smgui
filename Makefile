...
PARITY_CASES := empty label-normal button-normal button-explicit-size button-hover button-pressed button-disabled checkbox-normal checkbox-checked checkbox-hover
CASE ?= empty
WIDTH ?= 64
HEIGHT ?= 48
FUZZ_SEED ?= 1
