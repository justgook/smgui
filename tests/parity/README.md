...
`decimal-explicit-size`, `decimal-disabled`, `hex-normal`, and `hex-zero`.
...
`progress-maximum`, `progress-disabled`, `decimal-normal`, and `decimal-negative`, `decimal-explicit-size`, `decimal-disabled`, `hex-normal`, and `hex-zero` fixtures.
