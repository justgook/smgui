...
`decimal-explicit-size`, `decimal-disabled`, `hex-normal`, `hex-zero`, `hex-explicit-size`, and `hex-disabled`.
...
`progress-maximum`, `progress-disabled`, `decimal-normal`, and `decimal-negative`, `decimal-explicit-size`, `decimal-disabled`, `hex-normal`, `hex-zero`, `hex-explicit-size`, and `hex-disabled` fixtures.
