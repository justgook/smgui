...
`decimal-explicit-size`, and `decimal-disabled`.
...
`progress-maximum`, `progress-disabled`, `decimal-normal`, and `decimal-negative`, `decimal-explicit-size`, and `decimal-disabled` fixtures.
