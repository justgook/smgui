...
`decimal-explicit-size`, `decimal-disabled`, and `hex-normal`.
...
`progress-maximum`, `progress-disabled`, `decimal-normal`, and `decimal-negative`, `decimal-explicit-size`, `decimal-disabled`, and `hex-normal`
fixtures.
