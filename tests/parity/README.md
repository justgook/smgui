...
`decimal-explicit-size`, `decimal-disabled`, `hex-normal`, `hex-zero`, and `hex-explicit-size`.
...
`progress-maximum`, `progress-disabled`, `decimal-normal`, and `decimal-negative`, `decimal-explicit-size`, `decimal-disabled`, `hex-normal`, `hex-zero`, and `hex-explicit-size` fixtures.
