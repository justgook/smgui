...
`slider-maximum`, `slider-interaction`, `slider-disabled`, and `progress-minimum`.
...
`slider-midpoint`, `slider-maximum`, `slider-interaction`, and `slider-disabled`, and `progress-minimum` fixtures.
