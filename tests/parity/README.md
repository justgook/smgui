...
cases are `empty`, `label-normal`, and `button-normal`; explicit button sizing is next.
...
from 32–256 by 24–192 across the completed `empty`, `label-normal`, and
`button-normal` fixtures.
